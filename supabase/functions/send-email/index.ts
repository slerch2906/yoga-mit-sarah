    ...
    switch (type) {
      ...
      case 'waitlist_joined': {
        ...
        if (isFreeEvent) {
          ...
          infoBlock = `<p style="font-size:15px">Du stehst jetzt auf der Warteliste für <strong>„${cn}"</strong>.</p>${hl(`<p style="margin:4px 0;font-size:14px">📅 ${fmtDate(data.date,data.timeStart)}</p><p style="margin:4px 0;font-size:14px">👥 Position: <strong>${esc(data.position)}</strong></p>`)}${hl(`<p style="margin:0 0 8px;font-size:14px;font-weight:bold">Wichtig — verbindliche Buchung:</p><p style="margin:4px 0;font-size:13px">Wenn ein Platz frei wird, rückst Du automatisch nach. <strong>Du hast danach noch 60 Minuten Zeit, Dich kostenlos wieder abzumelden</strong> — danach ist Deine Anmeldung verbindlich gebucht.</p><p style="margin:4px 0;font-size:13px">⚠️ Beachte die Stornofrist — nur bis <strong>7 Tage</strong> vorher kostenfrei. Danach fällt die volle Gebühr an, außer du ernennst einen Ersatzteilnehmer.</p><p style="margin:4px 0;font-size:13px">❤️ Danke für Dein Verständnis und deine Wertschätzung für meine Planung.</p>`,'#fff3d6')}`
        } else {
      ...
      case 'waitlist_promoted': {
        ...
        let regelBlock = ''
        if (isPaidEvent) {
          regelBlock = hl(`<p style="margin:0 0 8px;font-size:14px;font-weight:bold">Wichtig — verbindliche Anmeldung:</p><p style="margin:4px 0;font-size:13px">✅ <strong>Versehentlich von Warteliste nachgerückt? Du hast jetzt noch 60 Minuten Zeit, Dich kostenlos abzumelden. Danach bist Du verbindlich angemeldet.</strong></p><p style="margin:4px 0;font-size:13px;font-weight:bold;color:#6b2a2a">Kostenlose Stornierung nur bis zum Stundenanfang möglich!</p><p style="margin:4px 0;font-size:13px">✅ Die Bezahlung läuft direkt mit Sarah (PayPal oder Bar).</p><p style="margin:4px 0;font-size:13px">⚠️ <strong>Stornofrist: 7 Tage</strong> vor dem Event — bis dahin kannst du dich kostenfrei abmelden. Bei späterer Abmeldung fällt die <strong>volle Gebühr</strong> an.</p><p style="margin:4px 0;font-size:13px">👯 Du kannst aber gerne einen <strong>Ersatzkandidaten</strong> benennen — wende dich dafür direkt an Sarah.</p><p style="margin:4px 0;font-size:13px">❤️ Danke für Dein Verständnis und deine Wertschätzung für meine Planung.</p>`,'#fff3d6')
        } else if (isFreeEvent) {
          regelBlock = hl(`<p style="margin:0 0 8px;font-size:14px;font-weight:bold">Gut zu wissen</p><p style="margin:4px 0;font-size:13px">✅ Das Event ist kostenlos — einfach kommen und mitmachen.</p><p style="margin:4px 0;font-size:13px">✅ Du kannst Dich jederzeit wieder abmelden.</p>`,'#e8ede6')
        } else {
          regelBlock = `<p style="font-size:15px">Du hast <strong>60 Minuten Zeit</strong>, dich — auch innerhalb der 3-Stunden-Abmeldefrist — kostenlos abzumelden. Dein Credit kommt dann zurück.</p><p style="font-size:14px;font-weight:bold;color:#6b2a2a">Kostenlose Stornierung nur bis zum Stundenanfang möglich!</p>`
        }
        // Sarah-Regel 2026-05-29: Bei Kurs-/Einzelstunden UND bezahlten Events einen
        // direkten "Wieder absagen"-Button — fuer den Fall, dass man versehentlich
