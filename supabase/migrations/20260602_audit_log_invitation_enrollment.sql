...
-- Vorher schrieb consume_invitation_enrollment KEIN audit_log -> der frisch per
-- Einladung registrierte Yogi hatte keinen Protokoll-Eintrag (Luecke). Jetzt:
-- audit_log mit action 'yogi_enrolled_via_invitation', user_id = der Yogi selbst.
-- Stand: auf Staging angewandt; Prod folgt nach Freigabe von Sarah.
