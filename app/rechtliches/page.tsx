      ...
      {step === 2 && (
        <div className="flex flex-col flex-1 px-5 pt-4 pb-6">
          ...
          <div onScroll={handleScroll2}
            ...
            <p className="text-sm text-yoga-text/80 leading-relaxed mb-2">• Danach gilt: <strong>gebucht ist gebucht</strong> — die vollständige Kursgebühr fällt an.</p>
            <p className="text-sm text-yoga-text/80 leading-relaxed mb-2">• <strong>Option:</strong> Du kannst einen passenden Ersatzteilnehmer benennen.</p>
            <p className="text-sm text-yoga-text/80 leading-relaxed mb-4">Danke für Dein Verständnis und deine Wertschätzung für meine Planung ❤️</p>
            ...
            <p className="text-sm text-yoga-text/80 leading-relaxed mb-2">• Warteliste: Rückst du automatisch nach, hast du noch <strong>60 Minuten</strong> Zeit, dich kostenlos wieder abzumelden. Danach gilt die 7-Tage-Stornofrist.</p>
            <p className="text-sm text-yoga-text/80 leading-relaxed mb-4">Danke für Dein Verständnis und deine Wertschätzung für meine Planung ❤️</p>
