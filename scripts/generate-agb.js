...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p('Eine kostenfreie Stornierung ist bis 7 Tage vor Veranstaltungsbeginn möglich. Danach fällt die vollständige Veranstaltungsgebühr an. Sollte die Gebühr bis 7 Tage vorher noch nicht bezahlt sein, bleibt die Rechnung dennoch bestehen und ist vollständig zu begleichen. Ausnahme: Du benennst einen Ersatzteilnehmer, der deinen Platz einnimmt.'),
      ...
      bullet('Bei einer Stornierung zwischen 13 und 7 Tagen vor Kursbeginn fällt eine Bearbeitungsgebühr von 30 € an, da der Platz kurzfristig neu vergeben werden muss.'),
