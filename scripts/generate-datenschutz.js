...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p('Sie können Ihren Account jederzeit selbst in der App löschen unter: Profil → „Account löschen". Nach Ihrer Bestätigung läuft folgende Cascade automatisch ab:'),
      bullet('Alle zukünftigen Buchungen werden storniert'),
      bullet('Wartelisten-Einträge werden entfernt'),
      bullet('Freiwerdende Plätze werden automatisch der Warteliste angeboten (Auto-Promote bzw. Late-Offer)'),
      bullet('Offene Credits und Guthaben verfallen ersatzlos (siehe § 1.0 der AGB)'),
      bullet('Ihre Profildaten (Vor-/Nachname, Notfallkontakt, Geburtsdatum) werden entfernt bzw. anonymisiert'),
      bullet('Der App-interne Protokollverlauf wird anonymisiert (siehe § 9d)'),
      bullet('Sie erhalten an Ihre bisher hinterlegte E-Mail-Adresse eine Bestätigungs-E-Mail nach Art. 12 DSGVO mit der Zusammenfassung aller durchgeführten Schritte. Diese E-Mail ist die letzte Nachricht, die Sie von der App erhalten — unmittelbar danach wird auch Ihre E-Mail-Adresse aus dem System entfernt'),
      bullet('Sie werden ausgeloggt und können sich nicht mehr anmelden'),
      bullet('Die Verantwortliche (Sarah Lerch) wird parallel über die Löschung benachrichtigt und löscht eine eventuell vorhandene Papier-Anmelde-PDF im verschlüsselten Cloud-Speicher manuell'),
      ...
      bullet('Krankheits-Austragungen mit Guthaben-Information'),
      bullet('Bestätigung Ihrer Account-Löschung gemäß Art. 12 DSGVO (letzte E-Mail vor Entfernung Ihrer Adresse)'),
